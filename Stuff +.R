...
#---------------Tables--------------
#-------Fastballs Table-------
#First 10 rows and subset
top_10_FBs <- head(AllFBs[order(AllFBs$`Stuff+`, decreasing = TRUE), c("player_name", "pitch_type", "Stuff+", "Velocity", "Vertical_Break", "Horizontal_Break", "Spin_Rate", "Extension", "Vertical_Release", "Horizontal_Release")], 10)

# Create the caption
caption <- "Top 10 Stuff+ Fastballs"

# Make Table
tableFBs <- kable(top_10_FBs, caption = caption,
...
#-------Sliders Table---------
top_10_SLs <- head(SL[order(SL$`Stuff+`, decreasing = TRUE), c("player_name", "pitch_type", "Stuff+", "Velocity", "Vertical_Break", "Horizontal_Break", "Spin_Rate", "Extension", "Vertical_Release", "Horizontal_Release")], 10)

# Create the caption
caption <- "Top 10 Stuff+ Sliders"

# Make Table
tableSLs <- kable(top_10_SLs, caption = caption,
                  col.names = c("Player Name", "Pitch Type", "Stuff+", "Velocity", "Vertical Break", "Horizontal Break", "Spin Rate", "Extension", "Vertical Release", "Horizontal Release")) %>%
  kable_styling()
...
#--------Changeups Table---------
top_10_CHs <- head(CH[order(CH$`Stuff+`, decreasing = TRUE), c("player_name", "pitch_type", "Stuff+", "Velocity", "Vertical_Break", "Horizontal_Break", "Spin_Rate", "Extension", "Vertical_Release", "Horizontal_Release")], 10)

# Create the caption
caption <- "Top 10 Stuff+ Changeups"

# Make Table
tableCHs <- kable(top_10_CHs, caption = caption,
                  col.names = c("Player Name", "Pitch Type", "Stuff+", "Velocity", "Vertical Break", "Horizontal Break", "Spin Rate", "Extension", "Vertical Release", "Horizontal Release")) %>%
  kable_styling()
...
#--------Curveballs Table---------
top_10_CBs <- head(CB[order(CB$`Stuff+`, decreasing = TRUE), c("player_name", "pitch_type", "Stuff+", "Velocity", "Vertical_Break", "Horizontal_Break", "Spin_Rate", "Extension", "Vertical_Release", "Horizontal_Release")], 10)

# Create the caption
caption <- "Top 10 Stuff+ Curveballs"

# Make Table
tableCBs <- kable(top_10_CBs, caption = caption,
                  col.names = c("Player Name", "Pitch Type", "Stuff+", "Velocity", "Vertical Break", "Horizontal Break", "Spin Rate", "Extension", "Vertical Release", "Horizontal Release")) %>%
  kable_styling()
